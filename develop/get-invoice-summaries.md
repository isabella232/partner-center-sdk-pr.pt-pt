...
Para recuperar uma coleção [**FaturaSummaries**](invoice-resources.md#invoicesummaries) que contenha um [**FaturaSummary**](invoice-resources.md#invoicesummary) para cada tipo de moeda:

1. Utilize a sua coleção **IAggregatePartner.Faturas** para ligar para a propriedade **Resumos.**

2. Ligue para o método **Get().**
3. Para obter o saldo de um [**dado individual faturaSummary,**](invoice-resources.md#invoicesummary)aceda ao **imóvel BalanceAmount** para aquele membro da coleção.
...
Se for bem sucedido, este método devolve um recurso [**FaturaSummaries**](invoice-resources.md#invoicesummaries) no organismo de resposta.
