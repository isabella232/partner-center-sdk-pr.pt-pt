...
- Dois IDs de subscrição, um para a subscrição inicial e outro para a subscrição-alvo.

## <a name="c"></a>C\#

Para atualizar a subscrição de um cliente, primeiro [obtenha a subscrição do cliente.](get-a-subscription-by-id.md) Em seguida, obtenha uma lista de atualizações para essa subscrição, chamando a propriedade Upgrades seguida pelos **métodos** **Get()** ou **GetAsync().** Escolha uma atualização de destino a partir dessa lista de atualizações e, em seguida, chame a propriedade **upgrade da** subscrição inicial, seguida do método **Create().**
...
Utilize o seguinte parâmetro de consulta para a transição da subscrição.

| Nome                    | Tipo     | Necessário | Descrição                                       |
|-------------------------|----------|----------|---------------------------------------------------|
| **cliente-inquilino-id**  | **guid** | Y        | Um GUID correspondente ao cliente.             |
| **id-para-subscrição** | **guid** | Y        | Um GUID correspondente à subscrição inicial. |
| **id-for-target**       | **guid** | Y        | Um GUID correspondente à subscrição-alvo.  |
...
Se for bem sucedido, este método devolve um recurso de resultado **de atualização** no organismo de resposta.
