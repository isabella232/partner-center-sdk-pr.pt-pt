---
title: Obter as transferências de um cliente
description: Como obter uma lista de transferências de um cliente.
ms.date: 04/10/2020
...
|---------|------------------------------------------------------------------------------------------------------|
| **GET** | [*{baseURL}*](partner-center-rest-urls.md)/v1/clientes/{cliente-inquilino-id}/transferes HTTP/1.1 |
...
Se for bem sucedido, este método devolve uma lista de recursos da [TransferEntity](transfer-entity-resources.md) no organismo de resposta.
