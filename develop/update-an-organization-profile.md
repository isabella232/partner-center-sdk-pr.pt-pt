...
Para atualizar o seu perfil de organização, recupere o perfil e faça as alterações necessárias. Em seguida, use a sua coleção **IAggregatePartner.Profiles** e ligue para a propriedade **OrganizationProfile.** Por fim, ligue para o método **'Atualização).).**
...
|---------|-------------------------------------------------------------------------------|
| **PUT** | [*{baseURL}*](partner-center-rest-urls.md)/v1/perfis/organização HTTP/1.1 |
