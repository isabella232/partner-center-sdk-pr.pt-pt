...
Para obter os itens de linha comercial para a fatura especificada, tem de recuperar o objeto da fatura:
...
O **Fornecedor** identifica a origem das informações de pormenor faturadas (por exemplo, **uma vez).** A **FaturaLineItemType** especifica o tipo (por exemplo, **UsageLineItem**).

O seguinte código exemplo utiliza um circuito **de apreensão para** processar a recolha de itens de linha. Uma coleção separada de itens de linha é recuperada para cada **FaturaLineItemType**.
...
Utilize a primeira sintaxe para devolver uma lista completa de todos os itens de linha para a fatura dada. Para faturas grandes, utilize a segunda sintaxe com um tamanho especificado e uma compensação baseada em 0 para devolver uma lista de itens de linha paged. Utilize a terceira sintaxe para obter a próxima página de itens de linha de reconhecimento utilizando `seekOperation = "Next"` .

| Método  | URI do pedido                                                                                                                                                     |
|---------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **GET** | [*{baseURL}*](partner-center-rest-urls.md)/v1/faturas/{fatura-id}/lineitems?provider=onetime&invoicelineitemtype=usagelineitems&currencycode={currencycode} HTTP/1.1                              |
| **GET** | [*{baseURL}*](partner-center-rest-urls.md)/v1/faturas/{fatura-id}/lineitems?provider=onetime&invoicelineitemtype=usagelineitems&currencycode={currencycode}&size={size} HTTP/1.1  |
| **GET** | [*{baseURL}*](partner-center-rest-urls.md)/v1/faturas/{fatura-id}/lineitems?provider=onetime&invoicelineitemtype=usagelineitems&currencycode={currencycode}&size={size}&seekOperation=Next                               |
...
Os detalhes para este exemplo pedido e resposta REST são os seguintes:
